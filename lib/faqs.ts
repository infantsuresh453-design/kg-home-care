export const FAQS = [
  {
    q: "Do you service in Thoothukudi district?",
  ...
  },
  {
    ...
    a: "Yes. Bookings made before 4 PM are usually completed the same day in Tuticorin, Palayamkottai and nearby areas, subject to technician availability.",
  },
  {
    q: "Is there a warranty on repairs?",
    a: "Every repair comes with a 90-day service warranty in writing. If the same issue recurs within the warranty period, we fix it at no extra charge.",
  },
  {
